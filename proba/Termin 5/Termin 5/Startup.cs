...
using Termin_5.Mapping;
using Termin_5.Services;
...
namespace Termin_5
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Termin_5", Version = "v1" });
            ...
            services.AddDbContext<FacultyDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("FacultyDatabase")));
           ...
           .AddJwtBearer(options =>
           {
               options.TokenValidationParameters = new TokenValidationParameters //Podesavamo parametre za validaciju pristiglih tokena
               {
                   ...
                   ValidIssuer = "http://localhost:44388", //odredjujemo koji server je validni izdavalac
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Termin_5 v1"));
            }
